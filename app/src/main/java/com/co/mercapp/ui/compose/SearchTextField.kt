...
fun RectangleSearchTextField(
    ...
    SearchTextField(
        ...
        leadingIcon = {
            BackButton(doWhenBackButtonClicked = {
    ...
    SearchTextField(
        ...
        leadingIcon = {
            Icon(
                ...
                contentDescription = stringResource(id = R.string.title_product_name)
            )
        },
        doWhenSearchedTextChanged = doWhenSearchedTextChanged,
...
private fun SearchTextField(
    ...
    TextField(modifier = modifier.then(
                ...
                if (searchTextValue.text.isBlank().not()) {
                    IconButton(onClick = {
                        ...
                        Icon(
                            ...
                            contentDescription = stringResource(id = R.string.title_clear)
                        )
                    }
                }
            }
        ...
        placeholder = {
            Text(
                text = stringResource(id = R.string.title_search_product),
                maxLines = 1
            )
        },
        shape = shape,
